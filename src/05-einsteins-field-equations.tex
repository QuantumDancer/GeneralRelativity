...
\begin{tikzpicture}[x={(170:1cm)},y={(55:.7cm)},z={(90:1cm)}]
  \draw (2.5,-2.5,2) node[above right] {$\hspace{0.4cm}\Sigma_{t}$} -- (2.5,2.5,2) -- (-2.5,2.5,2) -- (-2.5,-2.5,2) -- cycle;
  \draw[looseness=0.4] (2.5,-2.5,-1) node[above right] {$\hspace{0.2cm}\Sigma_{t_0}$}
  ...
  -- cycle;
  \node at  (0,-1,-3) (a) {} ;
  \node[inner sep=1pt,circle,fill=black] at  (0,0,-1) (b) {} ;
     \node[inner sep=1pt,circle,fill=black] at  (0,0,2) (c) {} ;
     
     \node at  (0,1,3) (d) {} ;
 
 \draw (a) edge[in=-70,out=110,-,-] (b);
 \draw (b) edge[in=-70,out=110,-,-](c);
