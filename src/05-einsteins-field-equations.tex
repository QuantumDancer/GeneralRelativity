...
\end{remark}\popftn
%TODO fix footnotes
%\footnotetext{So that length has dimension of inverse mass.}
%\footnotetext{Where M referes to the dimenson of mass.}
...
In vacuum the field equation are
\begin{equation}
...
\end{align}
Where $\tensor{M}{_i_j}$ is a rest term containing lower order derivaties.
