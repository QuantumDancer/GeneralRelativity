...
\begin{figure}[htb]
    \begin{center}
        \begin{tikzpicture}[scale=2]
            \draw [<->,thick] (0,2)  node [above] {$y$} |- (2,0) node [right] {$x$};
            \draw (0,1.25) arc [radius=1.25, start angle=90, end angle=0];
            \draw [->] (0,0) -- (0.883883,0.883883);
