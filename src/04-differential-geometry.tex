...
%TODO pictures
\section{Riemannian Curvature Tensor}
%TODO sort section
...
\end{equation}
Therefore the Bianchi identity is identical to the second set of Maxwell's
equations \eqref{eq:maxwell_eqs}.
